...
function mostrarValorAlmacen()
{
    ...
    echo "El valor del almacen actual es de " . $valorAlmacen;
}
...
function aplicarDescuentoManga()
{
    ...
    foreach ($inventario as &$categoria) { // Iterar sobre todas las categorías
        foreach ($categoria as &$comic) { // Iterar sobre los cómics dentro de cada categoría
